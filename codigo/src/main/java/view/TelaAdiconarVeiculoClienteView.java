...
public class TelaAdiconarVeiculoClienteView extends javax.swing.JFrame {
    ...
    /**
     * Creates new form TelaAdiconarVeiculoClienteView
     */
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        if (cpf.isEmpty() || placa.isEmpty() || placa.length() != 7) {
            ...
            // Simulação de adição de veículo
            ...
            jTextField2.setText(""); // Limpa o campo de placa
            jButton2.setEnabled(false); // Desabilita o botão "Adicionar Veículo"
        }
    }                                        
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        if (cpf.isEmpty()) {
            ...
            // Simulação de busca: Se o CPF tem 11 dígitos, consideramos que o cliente existe
            if (cpf.length() == 11) {
