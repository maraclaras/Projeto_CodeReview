...
public class TelaRegistrarClienteView extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaRegistrarClienteView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        javax.swing.SwingUtilities.invokeLater(() -> {
            new TelaRegistrarClienteView().setVisible(true);
        });
    }
